              ...
              <div className="mt-6 sm:gap-4 sm:items-center sm:flex sm:mt-8">
                ...
                >
                  <div>
                    <label
                      htmlFor="quantity"
                      className="blocm text-sm font-medium text-gray-200 dark:text-white"
                    >
                      Jumlah
                    </label>
                    <input
                      ...
                      className="mt-1 block w-24 px-3 py-2 border border-gray-300 rounded-md shadow-sm dark:bg-gray-800 dark:border-gray-600 dark:text-white focus:outlinen-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm"
                    />
                  </div>

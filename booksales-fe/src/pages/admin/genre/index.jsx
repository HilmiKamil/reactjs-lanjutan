            ...
            <div className="overflow-x-auto">
              <table className="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                ...
                <tbody>
                  ...
                  { genres.length > 0 ?
                  genres.map((genres) => ( 
                  <tr key={genres.id} className="border-b dark:border-gray-700">
                    <th
                      scope="row"
                    ...
                    <td className="px-4 py-3">{genres.description }</td>
                    <td className="px-4 py-3 flex items-center justify-end relative">
                      <button
                        id={`dropdown-button-${genres.id}`}
                        onClick={() => toggleDropdown(genres.id)}
                      ...
                      >
                        <ul
                          ...
                          aria-labelledby={`dropdown-button-${genres.id}`}
                        >
                          <li>
                            <Link
                              to={`/admin/genres/edit/${genres.id}`}
                        ...
                        <div className="py-1">
                          <button
                            onClick={() => handleDelete(genres.id)}
